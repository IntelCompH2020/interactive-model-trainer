...
import { Stopword, StopwordPersist } from '@app/core/model/stopword/stopword.model';
import { WordListVisibility } from '@app/core/enum/wordlist-visibility.enum';
import { Moment } from 'moment';

export class StopwordEditorModel extends BaseEditorModel implements StopwordPersist {
	...
	public fromModel(item: Stopword): StopwordEditorModel {
		if (item) {
