On the main menu, when you hover over the "**Corpora**" item, two new options are getting revealed with the first one being "**Raw Corpora**", linking to a table with all the available raw datasets.
