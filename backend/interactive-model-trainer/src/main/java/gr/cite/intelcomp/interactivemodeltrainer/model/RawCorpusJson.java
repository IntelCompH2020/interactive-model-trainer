...
public class RawCorpusJson extends CorpusJson{
    ...
    public RawCorpusJson(RawCorpus corpus) {
        super(corpus);
        this.setRecords(corpus.getRecords());
        this.setDownload_date(corpus.getDownload_date());
        this.setSchema(corpus.getSchema());
        this.setSource(corpus.getSource());
    }
