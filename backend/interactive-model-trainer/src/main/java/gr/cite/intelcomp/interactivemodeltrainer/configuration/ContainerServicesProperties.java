...
public class ContainerServicesProperties {
    ...
    public static class ManageLists {
        public static List<String> ENTRY_CMD = new ArrayList<>(
    ...
    public static class ManageModels {
        public static List<String> ENTRY_CMD = new ArrayList<>(
                Arrays.asList("python", "/app/manageModels.py", "--path_TMmodels", "/data/models")
        );
        public static String PATH_TM_MODELS = "--path_TMmodels /data/models";
        public static String LIST_ALL_TOPIC_CMD = "--listTMmodels";
        public static String GET_TM_MODEL = "--getTMmodel";
        ...
        public static String GET_SIMILAR_TOPICS = "--getSimilarTopics";
        public static String SET_TPC_LABELS = "--setTpcLabels";
        public static String FUSE_TOPICS = "--fuseTopics";
        public static String SORT_TOPICS = "--sortTopics";
        public static String DELETE_TOPICS = "--deleteTopics";
